...
(function (a, b) {
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function () {
        ...
        }, f = a.jQuery, g = a.$, h, i = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, j = /\S/, k = /^\s+/, l = /\s+$/, m = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, n = /^[\],:{}\s]*$/, o = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, p = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, q = /(?:^|:|,)(?:\s*\[)+/g, r = /(webkit)[ \/]([\w.]+)/, s = /(opera)(?:.*version)?[ \/]([\w.]+)/, t = /(msie) ([\w.]+)/, t2 = /(trident.*rv:)([\w.]+)/, u = /(mozilla)(?:.*? rv:([\w.]+))?/, v = /-([a-z]|[0-9])/ig, w = /^-ms-/, x = function (a, b) {
        ...
        e.fn = e.prototype = {
            ...
            noConflict: function (b) {
                ...
                a = a.toLowerCase();
                var b = r.exec(a) || s.exec(a) || t.exec(a) || t2.exec(a) || a.indexOf("compatible") < 0 && u.exec(a) || [];
    ...
    }), "object" === typeof module && module && "object" === typeof module.exports ? module.exports = f : (a.jQuery = a.$ = f, "function" === typeof define && define.cmd && define("lib/jquery/jquery/jquery-1.7.2.min", [], function () {
        return f
    }))
})(window);